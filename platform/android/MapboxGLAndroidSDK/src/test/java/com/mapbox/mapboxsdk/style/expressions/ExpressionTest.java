...
//  @Test
//  public void testAllLiteral() throws Exception {
//    Object[] expected = new Object[] {"all", true, true, true};
...
//  @Test
//  public void testLetLiteral() throws Exception {
//    Object[] expected = new Object[] {"let", "letName", "value"};
...
//  }
  ...
  public void testStepExpression() throws Exception {
    ...
    Object[] actual = step(toNumber(get(literal("key"))), literal(11), literal(0), literal(111), literal(1), literal(1111)).toArray();
    assertTrue("expression should match", Arrays.deepEquals(expected, actual));
  }
  ...
  public void testLinear() throws Exception {
    ...
    Object[] actual = interpolate(linear(), literal(12), literal(stopZero), literal(stopOne), literal(stopTwo)).toArray();
    assertTrue("expression should match", Arrays.deepEquals(expected, actual));
  }
  ...
  public void testExponential() throws Exception {
    ...
    Object[] actual = interpolate(exponential(literal(12)), get(literal("x")), literal(0), literal(100), literal(200)).toArray();
    assertTrue("expression should match", Arrays.deepEquals(expected, actual));
  }
  ...
  public void testCubicBezier() throws Exception {
    ...
    Object[] actual = interpolate(cubicBezier(literal(1), literal(1), literal(1), literal(1)), get(literal("x")), literal(0), literal(100), literal(100), literal(200)).toArray();
    assertTrue("expression should match", Arrays.deepEquals(expected, actual));
  }
  ...
  public void testCubicBezierExpression() throws Exception {
    ...
    Object[] actual = interpolate(cubicBezier(get(literal("z")), literal(1), get(literal("y")), literal(1)), get(literal("x")), literal(0), literal(100), literal(200)).toArray();
    assertTrue("expression should match", Arrays.deepEquals(expected, actual));
  }
  ...
  public void testCubicBezierExpressionLiteral() throws Exception {
    ...
    Object[] actual = interpolate(cubicBezier(get("z"), literal(1), get("y"), literal(1)), get("x"), stop(0, 100), stop(100, 200)).toArray();
    assertTrue("expression should match", Arrays.deepEquals(expected, actual));
  }
}